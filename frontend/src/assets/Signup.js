  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-left">
        <Link to="/" className="auth-logo">Check<span>Mail</span></Link>
        <h2>Créez votre compte<br />gratuitement.</h2>
        <p>Rejoignez des milliers d'utilisateurs qui protègent leurs emails avec CheckMail.</p>
        <div className="auth-bullets">
          <div className="auth-bullet"><span>✓</span> Analyse illimitée</div>
          <div className="auth-bullet"><span>✓</span> Rapports PDF exportables</div>
          <div className="auth-bullet"><span>✓</span> Assistant IA disponible 24h/24</div>
        </div>
      </div>
